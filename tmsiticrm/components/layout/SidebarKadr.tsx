...
import { Star, User, LogOut, X, CalendarCheck, MessageSquareWarning } from "lucide-react";
...
const navItems = [
  ...
  { href: "/kadr/izohlar",  icon: MessageSquareWarning, label: "Izohlar"    },
...
export default function SidebarKadr() {
  ...
  return (
    <>
      <MobileTopBar accent="#FF8C42" letter="K" onOpen={() => setMobileOpen(true)} />
