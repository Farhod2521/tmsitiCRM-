            ...
            <table className="w-full">
              <thead>
                <tr style={{ borderBottom: "2px solid #F4F9FD" }}>
                  {["#", "Ism familiyasi", "Bo'lim", "Turi", "Izohi", "Sana", "Yozilgan", "Holat", "Amallar"].map(h => (
              ...
              <tbody>
                {visible.map((n, i) => {
                  ...
                  <tr key={n.id} className="hover:bg-[#FAFCFF] transition-colors"
                    style={{ borderBottom: "1px solid #F4F9FD", opacity: waitingFor(n.review_status, actionStatus) ? 0.55 : 1 }}
                    title={waitingFor(n.review_status, actionStatus) ?? undefined}>
                    ...
                    <td className="py-4 text-xs" style={{ color: "#91929E", paddingRight: 16, whiteSpace: "nowrap" }}>
                      {fmtDt(n.created_at)}
                    </td>
                    ...
                    <td className="py-4" style={{ paddingRight: 16 }}>
                      ...
                      {n.zamdirektor_by_nomi && (
                        <p className="text-[11px] mt-0.5" style={{ color: "#91929E" }}>
                          Zamdirektor: {n.zamdirektor_by_nomi}{n.zamdirektor_at ? `, ${fmtDt(n.zamdirektor_at)}` : ""}
                        </p>
                      )}
                    </td>

                    <td className="py-4">
                      {n.review_status === actionStatus ? (
                      ...
                      ) : waitingFor(n.review_status, actionStatus) ? (
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1.5 text-[11px] font-bold whitespace-nowrap"
                          ...
                          <Clock size={12} /> {waitingFor(n.review_status, actionStatus)}
                        </span>
                      ) : (
