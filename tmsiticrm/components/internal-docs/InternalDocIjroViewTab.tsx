...
export default function InternalDocIjroViewTab() {
  ...
  const load = useCallback(() => {
    setLoading(true);
    apiFetch<InternalDocListItem[]>("/internal-docs/ijro-view")
  ...
  return (
    <div style={{ background: "#FFFFFF", borderRadius: 20, boxShadow: "0 4px 24px rgba(196,203,214,0.15)" }}>
      <div className="px-6 py-5" style={{ borderBottom: "1px solid #F4F9FD" }}>
        ...
        <p className="text-xs mt-0.5" style={{ color: "#91929E" }}>Zamdirektor tomonidan tasdiqlangan hujjatlar</p>
      </div>
      <InternalDocTable docs={docs} loading={loading} showDept showCreator showZamdirektor onRowClick={d => setSelectedId(d.id)} />
