...
import { Users, Clock, AlertTriangle, XCircle, CheckCircle2, Send, X, CheckCheck, Loader2 } from "lucide-react";
...
export default function DavomatPage() {
  ...
  async function openNotify() {
    ...
    try {
      const d = await apiFetch<{ text: string; count: number }>(`/attendance/pending-message?date=${date}`);
        ...
        <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <button onClick={openNotify}
              ...
              <Send size={15} /> Telegram orqali eslatish
            </button>
          ...
          <div className="w-full max-w-[520px] p-7 relative"
            ...
            {notifyLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-10 text-center">
                ...
                <p className="font-bold text-base" style={{ color: "#0A1629" }}>Hammasi kelgan</p>
                <p className="text-sm mt-1" style={{ color: "#91929E" }}>Tanlangan sanada hali kelmagan xodim yo'q</p>
              </div>
            ) : (
              <>
