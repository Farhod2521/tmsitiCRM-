...
const Map<String, _StatusCfg> _statusCfg = {
  ...
  'qabul_qilindi': _StatusCfg(
    'Qabul qilindi',
    AppColors.success,
    Icons.check_circle_outline,
  ),
  'rad_etildi': _StatusCfg(
    'Rad etildi',
    AppColors.danger,
    Icons.cancel_outlined,
  ),
  'bajarilmoqda': _StatusCfg(
    'Bajarilmoqda',
    AppColors.warning,
    Icons.autorenew,
  ),
  'tasdiq_kutilmoqda': _StatusCfg(
...
class _TasksScreenState extends State<TasksScreen> {
  ...
  ({String text, Color color})? _daysLeft(String? dateStr) {
    ...
    if (days < 0)
      return (text: '${days.abs()} kun o\'tgan', color: AppColors.danger);
          ...
          child: _loading
              ...
              : ListView(
                  ...
                  children: [
                    ...
                    const Text(
                      'Sizga shaxsan biriktirilgan topshiriqlar',
                      ...
                      Container(
                        ...
                        child: Column(
                          children: const [
                            ...
                            SizedBox(height: 10),
                            Text(
                              'Sizga biriktirilgan topshiriq yo\'q',
                              style: TextStyle(
  ...
  Widget _buildTaskCard(IjroTask t) {
    final cfg =
        _statusCfg[t.holati] ??
        const _StatusCfg('Noma\'lum', AppColors.muted, Icons.help_outline);
    ...
    if (t.assignedAt != null) {
      try {
        dateLabel = DateFormat(
          'yyyy-MM-dd',
        ).format(DateTime.parse(t.assignedAt!));
      } catch (_) {}
    }
    final showDecision =
        t.qarorByNomi != null &&
        (t.holati == 'qabul_qilindi' ||
            t.holati == 'rad_etildi' ||
            t.holati == 'bajarildi');
        ...
        child: Column(
          ...
          children: [
            ...
            if (t.docManba != null) ...[
              ...
              Text(
                ijroManbaLabels[t.docManba] ?? t.docManba!,
            ...
            if (showDecision) ...[
              const SizedBox(height: 6),
              Text(
                '${t.qarorByNomi} tomonidan ${ijroDecisionVerb(t.holati)}',
                style: const TextStyle(
                  fontSize: 12.5,
